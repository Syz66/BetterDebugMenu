...
public class DebugUtils {
    ...
    public static List<String> getDebugInfoRight() {
        ...
        List<String> list = Lists.newArrayList(String.format("Used memory: % 2d%% (%03dMB) of %03dMB", usableMem * 100L / maxMem, usableMem, maxMem), String.format("Allocated memory: % 2d%% (%03dMB)", totalMem * 100L / maxMem, totalMem), "");
        list.add(Minecraft.getMinecraft().getVersion());
